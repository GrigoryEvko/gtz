...
/-- The Trident family, listed. -/
theorem canonicalTridentFamily_eq_literal :
    canonicalTridentFamily
      = ({{0, 1, 2}, {0, 1, 3}, {0, 1, 4}, {2, 3, 5}} :
          Finset (Finset (Fin 6))) := by decide

/-- **THE TRIDENT KILL.**  No crux selects this family. -/
theorem SixThreeCrux.false_of_family_canonicalTridentFamily
    (crux : SixThreeCrux)
  ...
  have hblockCases : block = {0, 1, 2} ∨ block = {0, 1, 3} ∨ block = {0, 1, 4} ∨ block = {2, 3, 5} := by
    have hmem := hblockMem
    rw [hfamily, canonicalTridentFamily_eq_literal] at hmem
  ...
  · -- selected {0, 1, 2}
    have heraseEq : canonicalTridentFamily.erase {0, 1, 2}
        = ({{0, 1, 3}, {0, 1, 4}, {2, 3, 5}} :
            Finset (Finset (Fin 6))) := by decide
    have hcov1 : (4 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 4} := by
      obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 4
      rw [hfamily, canonicalTridentFamily_eq_literal] at hcoverMem
      ...
      · exact hcoverAtom
      · exact absurd (totalTightSupport_subset tightVec (by decide) hcoverAtom) (by decide)
    have hcov2 : (5 : Fin 6) ∈ totalTightSupport tightVec {2, 3, 5} := by
    ...
    ·
      ...
      have hcoeff7 : coefficient {0, 1, 4} = 0 :=
      ...
      have hcoeff8 : coefficient {2, 3, 5} = 0 :=
  ...
  · -- selected {0, 1, 3}
    have heraseEq : canonicalTridentFamily.erase {0, 1, 3}
        = ({{0, 1, 2}, {0, 1, 4}, {2, 3, 5}} :
            Finset (Finset (Fin 6))) := by decide
    have hcov11 : (4 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 4} := by
      obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 4
      rw [hfamily, canonicalTridentFamily_eq_literal] at hcoverMem
      simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
      rcases hcoverMem with rfl | rfl | rfl | rfl
      ...
      · exact hcoverAtom
      · exact absurd (totalTightSupport_subset tightVec (by decide) hcoverAtom) (by decide)
    have hcov12 : (5 : Fin 6) ∈ totalTightSupport tightVec {2, 3, 5} := by
      obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 5
      rw [hfamily, canonicalTridentFamily_eq_literal] at hcoverMem
      simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
      rcases hcoverMem with rfl | rfl | rfl | rfl
    ...
    ·
      ...
      have hcoeff17 : coefficient {0, 1, 4} = 0 :=
      ...
      have hcoeff18 : coefficient {2, 3, 5} = 0 :=
  ...
  · -- selected {0, 1, 4}
    have heraseEq : canonicalTridentFamily.erase {0, 1, 4}
        = ({{0, 1, 2}, {0, 1, 3}, {2, 3, 5}} :
            Finset (Finset (Fin 6))) := by decide
    have hcov21 : (5 : Fin 6) ∈ totalTightSupport tightVec {2, 3, 5} := by
      obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 5
      rw [hfamily, canonicalTridentFamily_eq_literal] at hcoverMem
      simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
      rcases hcoverMem with rfl | rfl | rfl | rfl
      ...
      · rw [hpairEq] at hcoverAtom
        exact absurd (hpairSubset hcoverAtom) (by decide)
      · exact hcoverAtom
    by_cases hmemSplit22 : (2 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 2}
    ·
      ...
      ·
        ...
        have hcancelAt25 := hcancel 2 (fun hmem => absurd (hpairSubset hmem) (by decide))
        have hcancelAt26 := hcancel 3 (fun hmem => absurd (hpairSubset hmem) (by decide))
        rw [hfamily, heraseEq, Finset.sum_insert (by decide),
          Finset.sum_insert (by decide), Finset.sum_singleton]
          at hcancelAt24 hcancelAt25 hcancelAt26
        have hcoeff27 : coefficient {2, 3, 5} = 0 :=
        ...
        have hcoeff29 : coefficient {0, 1, 3} = 0 :=
          secondCoeff_eq_zero_of_sum_three hcancelAt26
            (Or.inl hcoeff28)
            (Or.inl hcoeff27)
    ...
    ·
      have hpin31 : totalTightSupport tightVec {0, 1, 2} = {0, 1} :=
        eq_pair_of_notMem_third (totalTightSupport_subset tightVec (by decide))
  ...
  · -- selected {2, 3, 5}
    have heraseEq : canonicalTridentFamily.erase {2, 3, 5}
        = ({{0, 1, 2}, {0, 1, 3}, {0, 1, 4}} :
            Finset (Finset (Fin 6))) := by decide
    ...
    · -- pair {2, 5}
      ...
      have hcov32 : (3 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 3} := by
        ...
        · rw [hpairPin] at hcoverAtom
          exact absurd hcoverAtom (by decide)
      have hcov33 : (4 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 4} := by
        obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 4
        rw [hfamily, canonicalTridentFamily_eq_literal] at hcoverMem
        simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
        rcases hcoverMem with rfl | rfl | rfl | rfl
        ...
        · rw [hpairPin] at hcoverAtom
          exact absurd hcoverAtom (by decide)
      by_cases hmemSplit34 : (0 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 2}
      ·
        have hcancelAt35 := hcancel 3 (by rw [hpairSetEq]; decide)
        have hcancelAt36 := hcancel 4 (by rw [hpairSetEq]; decide)
        have hcancelAt37 := hcancel 0 (by rw [hpairSetEq]; decide)
        rw [hfamily, heraseEq, Finset.sum_insert (by decide),
          Finset.sum_insert (by decide), Finset.sum_singleton]
        ...
        have hcoeff39 : coefficient {0, 1, 4} = 0 :=
      ...
      ·
        have hpin41 : totalTightSupport tightVec {0, 1, 2} = {1, 2} :=
        ...
        have hcancelAt44 := hcancel 1 (by rw [hpairSetEq]; decide)
        rw [hfamily, heraseEq, Finset.sum_insert (by decide),
          Finset.sum_insert (by decide), Finset.sum_singleton]
        ...
        have hcoeff45 : coefficient {0, 1, 3} = 0 :=
          secondCoeff_eq_zero_of_sum_three hcancelAt42
            ...
            (Or.inr (totalEigenSquareRow_eq_zero_of_notMem_totalTightSupport tightVec (by decide) (fun hmem => absurd (totalTightSupport_subset tightVec (by decide) hmem) (by decide))))
            (ne_of_gt (totalEigenSquareRow_pos_of_mem_totalTightSupport tightVec (by decide) hcov32))
        have hcoeff46 : coefficient {0, 1, 4} = 0 :=
    ...
    · -- pair {3, 5}
      have hpairSetEq : ({pairFirst, pairSecond} : Finset (Fin 6)) = {3, 5} :=
        hpairEq.symm.trans hpairPin
      have hcov48 : (2 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 2} := by
        ...
        · rw [hpairPin] at hcoverAtom
          exact absurd hcoverAtom (by decide)
      have hcov49 : (4 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 4} := by
        obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 4
        rw [hfamily, canonicalTridentFamily_eq_literal] at hcoverMem
        simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
        rcases hcoverMem with rfl | rfl | rfl | rfl
        ...
        · rw [hpairPin] at hcoverAtom
          exact absurd hcoverAtom (by decide)
      by_cases hmemSplit50 : (0 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 3}
      ·
        have hcancelAt51 := hcancel 2 (by rw [hpairSetEq]; decide)
        ...
        have hcoeff54 : coefficient {0, 1, 2} = 0 :=
        ...
        have hcoeff55 : coefficient {0, 1, 4} = 0 :=
          thirdCoeff_eq_zero_of_sum_three hcancelAt52
            (Or.inl hcoeff54)
            (Or.inr (totalEigenSquareRow_eq_zero_of_notMem_totalTightSupport tightVec (by decide) (fun hmem => absurd (totalTightSupport_subset tightVec (by decide) hmem) (by decide))))
            (ne_of_gt (totalEigenSquareRow_pos_of_mem_totalTightSupport tightVec (by decide) hcov49))
        have hcoeff56 : coefficient {0, 1, 3} = 0 :=
          secondCoeff_eq_zero_of_sum_three hcancelAt53
            (Or.inl hcoeff54)
            (Or.inl hcoeff55)
      ...
      ·
        have hpin57 : totalTightSupport tightVec {0, 1, 3} = {1, 3} :=
          eq_pair_of_notMem_first (totalTightSupport_subset tightVec (by decide))
          (crux.two_le_card_totalTightSupport tightVec hunit hEigen {0, 1, 3} (by decide)) hmemSplit50 (by decide)
        have hcancelAt58 := hcancel 2 (by rw [hpairSetEq]; decide)
        have hcancelAt59 := hcancel 4 (by rw [hpairSetEq]; decide)
        have hcancelAt60 := hcancel 1 (by rw [hpairSetEq]; decide)
        rw [hfamily, heraseEq, Finset.sum_insert (by decide),
          Finset.sum_insert (by decide), Finset.sum_singleton]
          at hcancelAt58 hcancelAt59 hcancelAt60
        have hcoeff61 : coefficient {0, 1, 2} = 0 :=
          firstCoeff_eq_zero_of_sum_three hcancelAt58
            (Or.inr (totalEigenSquareRow_eq_zero_of_notMem_totalTightSupport tightVec (by decide) (fun hmem => absurd (totalTightSupport_subset tightVec (by decide) hmem) (by decide))))
            (Or.inr (totalEigenSquareRow_eq_zero_of_notMem_totalTightSupport tightVec (by decide) (fun hmem => absurd (totalTightSupport_subset tightVec (by decide) hmem) (by decide))))
            (ne_of_gt (totalEigenSquareRow_pos_of_mem_totalTightSupport tightVec (by decide) hcov48))
        have hcoeff62 : coefficient {0, 1, 4} = 0 :=
          thirdCoeff_eq_zero_of_sum_three hcancelAt59
            (Or.inl hcoeff61)
            (Or.inr (totalEigenSquareRow_eq_zero_of_notMem_totalTightSupport tightVec (by decide) (fun hmem => absurd (totalTightSupport_subset tightVec (by decide) hmem) (by decide))))
            (ne_of_gt (totalEigenSquareRow_pos_of_mem_totalTightSupport tightVec (by decide) hcov49))
        have hcoeff63 : coefficient {0, 1, 3} = 0 :=
