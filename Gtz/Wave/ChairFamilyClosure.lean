...
/-- The Chair family, listed. -/
theorem canonicalChairFamily_eq_literal :
    canonicalChairFamily
      = ({{0, 1, 2}, {0, 1, 3}, {0, 1, 4}, {0, 2, 5}} :
          Finset (Finset (Fin 6))) := by decide

/-- **THE CHAIR KILL.**  No crux selects this family. -/
theorem SixThreeCrux.false_of_family_canonicalChairFamily
    (crux : SixThreeCrux)
  ...
  have hblockCases : block = {0, 1, 2} ∨ block = {0, 1, 3} ∨ block = {0, 1, 4} ∨ block = {0, 2, 5} := by
    have hmem := hblockMem
    rw [hfamily, canonicalChairFamily_eq_literal] at hmem
  ...
  · -- selected {0, 1, 2}
    ...
    have hcov1 : (3 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 3} := by
      ...
      · exact absurd (totalTightSupport_subset tightVec (by decide) hcoverAtom) (by decide)
    have hcov2 : (4 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 4} := by
      ...
      · exact hcoverAtom
      · exact absurd (totalTightSupport_subset tightVec (by decide) hcoverAtom) (by decide)
    have hcov3 : (5 : Fin 6) ∈ totalTightSupport tightVec {0, 2, 5} := by
    ...
    have hcancelAt6 := hcancel 5 (fun hmem => absurd (hpairSubset hmem) (by decide))
    ...
    have hcoeff8 : coefficient {0, 1, 4} = 0 :=
    ...
    have hcoeff9 : coefficient {0, 2, 5} = 0 :=
  ...
  · -- selected {0, 1, 3}
    have heraseEq : canonicalChairFamily.erase {0, 1, 3}
        = ({{0, 1, 2}, {0, 1, 4}, {0, 2, 5}} :
            Finset (Finset (Fin 6))) := by decide
    have hcov10 : (4 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 4} := by
      obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 4
      rw [hfamily, canonicalChairFamily_eq_literal] at hcoverMem
      simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
      rcases hcoverMem with rfl | rfl | rfl | rfl
      ...
      · exact hcoverAtom
      · exact absurd (totalTightSupport_subset tightVec (by decide) hcoverAtom) (by decide)
    have hcov11 : (5 : Fin 6) ∈ totalTightSupport tightVec {0, 2, 5} := by
      obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 5
      rw [hfamily, canonicalChairFamily_eq_literal] at hcoverMem
      simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
      rcases hcoverMem with rfl | rfl | rfl | rfl
    ...
    ·
      ...
      have hcancelAt15 := hcancel 2 (fun hmem => absurd (hpairSubset hmem) (by decide))
      rw [hfamily, heraseEq, Finset.sum_insert (by decide),
        Finset.sum_insert (by decide), Finset.sum_singleton]
        at hcancelAt13 hcancelAt14 hcancelAt15
      have hcoeff16 : coefficient {0, 1, 4} = 0 :=
      ...
      have hcoeff17 : coefficient {0, 2, 5} = 0 :=
    ...
    ·
      have hpin19 : totalTightSupport tightVec {0, 1, 2} = {0, 1} :=
  ...
  · -- selected {0, 1, 4}
    have heraseEq : canonicalChairFamily.erase {0, 1, 4}
        = ({{0, 1, 2}, {0, 1, 3}, {0, 2, 5}} :
            Finset (Finset (Fin 6))) := by decide
    have hcov20 : (3 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 3} := by
      ...
      · rw [hpairEq] at hcoverAtom
        exact absurd (hpairSubset hcoverAtom) (by decide)
      · exact absurd (totalTightSupport_subset tightVec (by decide) hcoverAtom) (by decide)
    have hcov21 : (5 : Fin 6) ∈ totalTightSupport tightVec {0, 2, 5} := by
      obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 5
      rw [hfamily, canonicalChairFamily_eq_literal] at hcoverMem
      simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
      rcases hcoverMem with rfl | rfl | rfl | rfl
    ...
    ·
      have hcancelAt23 := hcancel 3 (fun hmem => absurd (hpairSubset hmem) (by decide))
      ...
      have hcoeff26 : coefficient {0, 1, 3} = 0 :=
      ...
      have hcoeff27 : coefficient {0, 2, 5} = 0 :=
    ...
    ·
      have hpin29 : totalTightSupport tightVec {0, 1, 2} = {0, 1} :=
        eq_pair_of_notMem_third (totalTightSupport_subset tightVec (by decide))
  ...
  · -- selected {0, 2, 5}
    have heraseEq : canonicalChairFamily.erase {0, 2, 5}
        = ({{0, 1, 2}, {0, 1, 3}, {0, 1, 4}} :
            Finset (Finset (Fin 6))) := by decide
    have hcov30 : (3 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 3} := by
      obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 3
      rw [hfamily, canonicalChairFamily_eq_literal] at hcoverMem
      simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
      rcases hcoverMem with rfl | rfl | rfl | rfl
      ...
      · rw [hpairEq] at hcoverAtom
        exact absurd (hpairSubset hcoverAtom) (by decide)
    have hcov31 : (4 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 4} := by
      obtain ⟨coverBlock, hcoverMem, hcoverAtom⟩ := hcoverage 4
      rw [hfamily, canonicalChairFamily_eq_literal] at hcoverMem
      simp only [Finset.mem_insert, Finset.mem_singleton] at hcoverMem
      rcases hcoverMem with rfl | rfl | rfl | rfl
      ...
      · rw [hpairEq] at hcoverAtom
        exact absurd (hpairSubset hcoverAtom) (by decide)
    by_cases hmemSplit32 : (1 : Fin 6) ∈ totalTightSupport tightVec {0, 1, 2}
    ·
      have hcancelAt33 := hcancel 3 (fun hmem => absurd (hpairSubset hmem) (by decide))
      have hcancelAt34 := hcancel 4 (fun hmem => absurd (hpairSubset hmem) (by decide))
      have hcancelAt35 := hcancel 1 (fun hmem => absurd (hpairSubset hmem) (by decide))
      rw [hfamily, heraseEq, Finset.sum_insert (by decide),
        Finset.sum_insert (by decide), Finset.sum_singleton]
      ...
      have hcoeff37 : coefficient {0, 1, 4} = 0 :=
    ...
    ·
      have hpin39 : totalTightSupport tightVec {0, 1, 2} = {0, 2} :=
