...
instantiates `two_piece_law_assembly` (`Gtz.Certificates.LawEquivalence`). The other lemmas
...
kernel `two_piece_law_assembly` (`Gtz.Certificates.LawEquivalence`).  This is residual 4's
