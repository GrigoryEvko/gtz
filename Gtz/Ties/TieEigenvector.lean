...
This is the entry point the frame-existence approach (`Gtz.Certificates.FrameBridge`,
`Gtz.Reduction.RayleighCertificate`) builds on — every tie is a dominating subset carrying an
