...
| `Gtz/DustControl.lean` | **Proposition D**: mixed positivity, dust-pair floor, dust deficit ≥ −2δ₀δ₂ (tight, via the expansion identity) | **proved** (dust hypothesis unnecessary — hygiene find) |
