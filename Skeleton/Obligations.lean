...
axiom obligationKnifeBandRefinedKFour :
    Gtz.KFourKnifeBandRefinedPathPointerOrStarWeakToStrict
...
theorem obligationKFourFamilySelection : Gtz.KFourFamilySelection :=
  Gtz.kFourFamilySelection_iff_pathPointerOrStar.mpr
    obligationKnifeBandRefinedKFour

/-- The path-pointer-or-star A3 axiom reconstructs the former refined knife band
...
path's outside repair pointer, and the automatic chart-heavy law. -/
theorem obligationKnifeBandRefinedKFour_full :
    Gtz.KFourKnifeBandRefinedWeakToStrict :=
  Gtz.kFourKnifeBandRefinedPathPointerOrStar_iff.mp
    obligationKnifeBandRefinedKFour
