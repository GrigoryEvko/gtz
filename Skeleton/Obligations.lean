...
* Root A, rank three: `forall n, 0 < n -> Gtz.GtzOriginal n 3`.  Rests on FIVE
  ...
  - `obligationKnifeBandRefinedKFour` =
    ...
    cleared to division-free polynomial edge-budget inequalities.  Every one
    of the sixteen spanning trees now has a moduli-only cell.  Both quantifiers are
