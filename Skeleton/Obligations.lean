...
* Root A, rank three: `forall n, 0 < n -> Gtz.GtzOriginal n 3`.  Rests on FIVE
  ...
  - `obligationKnifeBandRefinedKFour` =
    `Gtz.KFourKnifeBandRefinedTreeStarSpanningExchangeWallWeakToStrict`, strictness demanded
    ...
    leaving only a positive tree reading or the strict two-sided boost-ratio
    reversal.  The exact washout
...
axiom obligationKnifeBandRefinedKFour :
    Gtz.KFourKnifeBandRefinedTreeStarSpanningExchangeWallWeakToStrict
...
theorem obligationKFourFamilySelection : Gtz.KFourFamilySelection :=
  Gtz.kFourFamilySelection_iff_treeStarSpanningExchangeWall.mpr
    obligationKnifeBandRefinedKFour
...
theorem obligationKnifeBandRefinedKFour_full :
  ...
  Gtz.kFourKnifeBandRefinedTreeStarSpanningExchangeWall_iff.mp
    obligationKnifeBandRefinedKFour
