...
axiom obligationChartTieFreeThreeLinesFundamentalDomain :
    Gtz.ChartTieFreeThreeLinesFundamentalDomainTenthHeavyBudgetReadingBlind

/-- The combined blind A2 axiom reconstructs the former fundamental-domain
statement by spending chart whitening, the strict tenth-light theorem, both
allocated budget cells, and the max-reading cover cell. -/
theorem obligationChartTieFreeThreeLinesFundamentalDomain_full :
    Gtz.ChartTieFreeThreeLinesFundamentalDomain :=
  Gtz.chartTieFreeThreeLinesFundamentalDomain_of_budgetReadingBlind
    obligationChartTieFreeThreeLinesFundamentalDomain
