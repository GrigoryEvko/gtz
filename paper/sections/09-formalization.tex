...
The development is carried out in Lean~4 over Mathlib.  A statement whose head
carries the tag \emph{Lean} is verified there.  Table~\ref{tab:lean} names the declaration
for the statements it lists, and where a listed statement is assembled from
several formal statements, all of them are named; a tagged statement absent
