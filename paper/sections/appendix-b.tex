...
\[
  \Lambda=v\sum_C\lambda_C\,u_C^{\vphantom{\mathsf{T}}}u_C\tp
   =1\cdot\sum_{c_0}\tfrac14\cdot\tfrac13\,g_{c_0}^{\vphantom{\mathsf{T}}}g_{c_0}\tp
   =\tfrac1{12}\cdot4I_3=\tfrac13 I_3,
  \qquad \tr\Lambda=1=v .
\]
The quadric law \eqref{eq:statt} reads $g_c\tp\Lambda g_c=\ell_c/3=1=v$, and
...
slack $\varepsilon>0$, and display the resulting determinant $(3\varepsilon-2\tau-3\tau^{2})/9$ of
\eqref{eq:family} changing sign at $\tau\asymp \varepsilon$.
\end{wip}
...
through a construction used again in \S\ref{app:split}.  Let $\gph$ be a
...
$y\tp Ly=3+3=6$, so the gap form equals $-6$; likewise at $E'=\{ab,ad,bd\}$
...
\end{array}
\]
The total is $2102$.  Setting aside the single class of cardinality two ---
the partition branch that Corollary~\ref{cor:e3} leaves undecided, and does
not exclude --- leaves $2101$.  By
