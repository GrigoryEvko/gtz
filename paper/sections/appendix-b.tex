...
\eqref{eq:parseval} can be checked in finite arithmetic, and every
constant quoted is exact.  Radicals occur in three places: the
icosahedral design of \S\ref{app:icosa}, the whitener of a graphic design
in \S\ref{app:diamond}, and the normalization of the tetrahedron.  Each
time, the algebraic relation that eliminates them is displayed.  No entry
rests on a floating-point evaluation.
...
\end{array}
\]
The total is $2102$.  The single class of cardinality two is the
partition branch that Corollary~\ref{cor:e3} leaves undecided and does
not exclude; setting it aside leaves $2101$.  By
