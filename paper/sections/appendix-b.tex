...
time, the algebraic relation that eliminates them is displayed.
...
whose gap at the surviving index $0$ is exactly $0$, at every $\tau$.
...
form equals $-6$; likewise at $E'=\{ab,ad,bd\}$ with $y=(0,0,1)$.  The certificates for all ten subsets are
\[
  \begin{array}{llll}
...
nonempty classes there is an extremal design.}  At $k=3$ and $m=6$ the class
profiles are $(3,1,1,1)$ and $(2,2,1,1)$; at $m=7$ they are $(4,1,1,1)$,
$(3,2,1,1)$ and $(2,2,2,1)$.  The two families displayed above are the
profiles $(2,2,1,1)$ and $(2,2,2,1)$.  Since a member of this family has at
most $k+1$ distinct
...
design on which the two-moment criterion is silent.
