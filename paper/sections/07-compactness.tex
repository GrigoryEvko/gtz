...
delete $z$, renormalize, lift a dominating subset back --- is meaningful
at any $t_z<1$.  A minimizing-sequence argument would need that composite
and not the boundary statement, since along such a sequence the weight at
the escaping label is positive and merely tends to zero.  The composite
fails at every positive weight, and no threshold in $t_z$ repairs it.
