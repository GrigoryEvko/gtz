...
\end{align*}
The leverages and the arithmetic at $\tau=\tfrac14$ are in
\S\ref{app:liftfail}.
\end{example}
...
\begin{figure}[ht]
  \centering
  \input{figures/boundarytrace}
  \caption{The dichotomy of Theorem~\ref{thm:boundary} executed on the
  chart point of \S\ref{app:liftfail}, at $(4,2)$ with pivot $z=1$.
