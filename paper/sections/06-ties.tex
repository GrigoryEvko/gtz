...
for.  What the identities do not supply is a common interlacing of the
characteristic polynomials, and without one the least root of the average
bounds the least root of no member (\S\ref{sec:averaging}).
...
unitary $U=V\adj V'$.  Replacing $z$ by $\diag(\varepsilon)z$ replaces $P$ by
...
$X=V\adj D_\sigma$ and $Y=V$ gives, since scaling the column $c$ of
