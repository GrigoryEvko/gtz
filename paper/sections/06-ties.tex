...
corank one, computes its dimension, and draws the no-margin consequence used
throughout the sequel.  It then examines the probability measure on
$k$-subsets adapted to \eqref{eq:parseval}, under which the selection
inequality holds on average, and states what that average does and does
not give.
...
\S\ref{sec:interior} supply.  Appendix~\ref{app:graveyard} collects the strategies that fail for
