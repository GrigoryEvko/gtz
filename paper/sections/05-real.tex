...
\eqref{eq:doubleangle} and the light/heavy split are theirs.  The passage
to arbitrary weights is new; it costs the reweighting of
Theorem~\ref{thm:light} in the light branch, and it replaces the
Perron--Frobenius step of \cite{SenguptaPautov2026} by
Lemma~\ref{lem:rowsum} and the trace computation of
Lemma~\ref{lem:spanning} in the heavy branch.
