...
\begin{equation}\label{eq:obstruction}
  K_{cd}\;:=\;\langle \eta_c,\eta_d\rangle-\hat\ell_c\nu_d+2 .
\end{equation}
\end{definition}
...
\begin{equation}\label{eq:pairdom}
  ...
  \;\psd\;T\;=\;\sum_c t_c\,w_c^{\vphantom{\mathsf{T}}}w_c\tp .
\end{equation}
With $R\tp TR=I_2$ and $h_c:=R\tp w_c$, condition \eqref{eq:pairdom} is
...
that $\win(k)$ is the true threshold; see Problem~\ref{prob:higher}.
...
$\lvert C^{+}\rvert=k$ dominates in $\dsn^{+}$.  By Lemma~\ref{lem:repeat}, $\Sdual$
