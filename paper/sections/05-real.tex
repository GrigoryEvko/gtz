...
outstanding, and nothing so far bounds the size at all.  One device
supplies both: an operation that produces from a design a smaller design
...
can be settled outright (\S\ref{sec:ranktwo}).
...
$\lmin(\SC)=1$.  Here a pattern begins that runs through the paper: the reductions
