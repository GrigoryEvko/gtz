...
weight family of Example~\ref{ex:liftfailure}, whose relevant $2\times2$ block has
...
The signature of $W$ is excluded by Remark~\ref{rem:nogo}: a proof of
$\Gtz$ cannot run on the inertia of $W$ alone.
\end{remark}
