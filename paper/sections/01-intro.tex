...
the matrix $V$ with rows $v_c\adj$ is an isometry, and \eqref{eq:dominate}
into a comparison between a principal block of the projection $P=VV\adj$
...
a multiplier $\Lambda$ obeying a quadric law $g_c\adj\Lambda g_c=v$ at
