...
the first statement $(M\adj)^{-1}$ is a contraction as well, and
...
\[
  ...
  \;=\;2a^2+2ab+2b^2,
\]
which is positive definite, its discriminant $4-16$ being negative; so
$B_3$ has at least two positive eigenvalues, and $\det B_3<0$ excludes
three, leaving inertia $(2,1,0)$, the inertia
